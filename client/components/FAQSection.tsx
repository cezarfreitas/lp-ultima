    ...
    try {
      ...
      if (response.ok) {
        ...
        setSectionData({
          ...
          subtitle: "Tire suas dúvidas sobre como se tornar um lojista Ecko e começar a lucrar com nossa marca.",
        ...
        <div className="text-center mt-12">
          ...
          >
            ...
            <svg className="ml-2 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-3.582 8-8 8a8.001 8.001 0 01-7.747-6M3 12c0-4.418 3.582-8 8-8s8 3.582 8 8" />
            </svg>
          </a>
        </div>
      </div>
