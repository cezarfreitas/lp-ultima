...
interface MultiImageUploadFallbackProps {
...
export default function MultiImageUploadFallback({
  onImagesUploaded,
  maxFiles = 10,
  maxWidth = 1200,
  quality = 0.8,
}: MultiImageUploadFallbackProps) {
  ...
  const handleFileSelection = async (
    ...
    for (let i = 0; i < newImages.length; i++) {
      ...
      try {
        ...
        // Upload to server using original endpoint
