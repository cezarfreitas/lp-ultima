  ...
  const handleAddFAQ = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessage({
          type: "error",
          text: errorData.error || "Erro ao adicionar FAQ",
        });
      }
    } catch (error) {
  ...
  const handleUpdateFAQ = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessage({
          type: "error",
          text: errorData.error || "Erro ao atualizar FAQ",
        });
      }
    } catch (error) {
  ...
  const handleDeleteFAQ = async (faqId: number) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessage({
          type: "error",
          text: errorData.error || "Erro ao deletar FAQ",
        });
      }
    } catch (error) {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("max_faqs", parseInt(e.target.value))
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                  />
                </div>
              ...
              {faqs.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500">
                    Comece adicionando algumas perguntas frequentes.
                  </p>
                </div>
              )}
            </div>
